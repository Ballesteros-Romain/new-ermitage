...
<head>
    ...
    <meta name="description" content="location à la semaine dans un cadre ydillique" img="">
    ...
    <header>
       <nav class="container-fluid">
        <ul class="list-unstyled d-flex justify-content-around" >
            ...
            <li class="mt-4 text-navbar"><a href="/php/contact.php">Accès</a></li>
        </ul>
       </nav>         
    </header>
</body>
<button
        ...
        id="btn-back-to-top"
        >
 <img src="PHOTOS/arrow-up.svg" alt="">
</button>